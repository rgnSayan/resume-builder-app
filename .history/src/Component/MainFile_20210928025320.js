...
function MainFile() {
    ...
    return (
        <div className="mainFile">
            ...
            <div className="btn" >
                <Button variant="contained" color="primary" disabled={!name} onClick={() => setOpen(!open)}>View CV
                </Button>
            </div>

            {open ? (
                <div className="resume__container">
                    <Resume ref={componentRef} name={name} bio={bio} email={email} address={address} phone={phone} bday={bday}
                    ...
                    // expIDescription={expIDescription} expIIName={expIIName} expIIPos={expIIPos} expIIMon={expIIMon}
                    // expIIDescription={expIIDescription}/>
                    <div className="download">
                        <Button variant="contained" color="secondary" disabled={!name} onClick={handlePrint}>
                            Download Resume
                        </Button>
                    </div>
                </div>

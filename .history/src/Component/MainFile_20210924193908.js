            ...
            <div className="skills">
                ...
                <div className="skills__container">
                    ...
                    <div className="skills__two">
                        <AddCircleOutlineIcon />
                        <input type="text" placeholder="Enter Your 2nd Skill" value={sk1}
                            onChange={e => setSk1(e.target.value)} />
                    </div>
                    <div className="skills__three">
                        <AddCircleOutlineIcon />
                        <input type="text" placeholder="Enter Your 3rd Skill" value={sk1}
                            onChange={e => setSk1(e.target.value)} />
                    </div>
                    <div className="skills__four">
                        <AddCircleOutlineIcon />
                        <input type="text" placeholder="Enter Your 4th Skill" value={sk1}
                            onChange={e => setSk1(e.target.value)} />
                    </div>
                    <div className="skills__five">
                        <AddCircleOutlineIcon />
                        <input type="text" placeholder="Enter Your 5th Skill" value={sk1}
                            onChange={e => setSk1(e.target.value)} />
                    </div>
                </div>
            </div>

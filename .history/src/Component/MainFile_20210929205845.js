...
function MainFile() {
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        db.collection('resumeDetails').add({
            name: name,
            bio: bio,
            email: email,
            address: address,
            ...
            schoolNameX: schoolNameX,
            percentageX: percentageX,
            boardX: boardX, endDateX: endDateX, startDateX: startDateX,
            schoolNameXII: schoolNameXII, percentageXII: percentageXII, boardXII: boardXII,
            endDateXII: endDateXII, startDateXII: startDateXII, universityName: universityName, cgpa: cgpa, universityBranch: universityBranch, universityStartDate: universityStartDate,
            universityEndDate: universityEndDate, sk1: sk1, sk2: sk2, sk3: sk3, sk4: sk4, sk5: sk5,
            prDetails: prDetails, prName: prName, prLink: prLink, prDetailsI: prDetailsI, prNameI: prNameI,
            prLinkI: prLinkI, expIName: expIIName, expIPos: expIPos, expIMon: expIIMon,
            expIDescription: expIDescription, expIIName: expIIName, expIIPos: expIIPos, expIIMon: expIIMon, expIIDescription: expIIDescription, timestamp: firebase.firestore.FieldValue.serverTimestamp()
        })
    }
    ...
    return (
        <div className="mainFile">
            ...
            <div className="btn" >
                <Button variant="contained" color="primary" endIcon={<TurnedInIcon />}>
                    Submit
                </Button>
                <Button variant="contained" color="secondary" disabled={!name} onClick={() => setOpen(!open)}
            ...
            {open ? (
                <div className="resume__container">
                    <Resume
                        ...
                        schoolNameXII={schoolNameXII} percentageXII={percentageXII} boardXII={boardXII}
                        endDateXII={endDateXII} startDateXII={startDateXII} universityName={universityName} cgpa={cgpa} universityBranch={universityBranch} universityStartDate={universityStartDate}
                        universityEndDate={universityEndDate} sk1={sk1} sk2={sk2} sk3={sk3} sk4={sk4} sk5={sk5} prDetails={prDetails} prName={prName} prLink={prLink} prDetailsI={prDetailsI} prNameI={prNameI} prLinkI={prLinkI} expIName={expIIName} expIPos={expIPos} expIMon={expIIMon}
                        expIDescription={expIDescription} expIIName={expIIName} expIIPos={expIIPos} expIIMon={expIIMon} expIIDescription={expIIDescription} />
                </div>
            ) : null}
        </div >
    )

            ...
            {open ? (
                <div className="resume__container">
                    <Resume
                        ...
                        universityEndDate={universityEndDate} sk1={sk1} sk2={sk2} sk3={sk3} sk4={sk4} sk5={sk5} prDetails={prDetails} prName={prName} prLink={prLink} prDetailsI={prDetailsI} prNameI={prNameI} prLinkI={prLinkI} expIName={expIIName} expIPos={expIPos} expIIMon={expIIMon} expIDescription={expIDescription}
                    />
                </div>
            ) : null}

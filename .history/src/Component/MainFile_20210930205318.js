                ...
                <div className="experience__container">
                    <div className="experience__content">
                        ...
                        <div className="experience__input">
                            ...
                            <input type="text" placeholder="Duration (No Of Months)" value={expIMon}
                    ...
                    <div className="experience__content">
                        ...
                        <div className="experience__input">
                            ...
                            <input type="text" placeholder="Duration (No Of Months)" value={expIIMon}
            ...
            <div className="btnRight" >
                <Link to="/resume">
                    <Button variant="contained" color="secondary" onClick={() => setOpen(!open)}
                        endIcon={<ArrowRightIcon />} disabled={!button}>
                        Continue
                    </Button>
                </Link>
            </div>

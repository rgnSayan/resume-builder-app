...
function Resume({ name, bio, email, address, phone, bday, githubInput, linkedinInput, schoolNameX,
    ...
    universityEndDate, sk1, sk2, sk3, sk4, sk5, prDetails, prName, prLink, prDetailsI, prNameI, prLinkI, expIName, expIPos, expIMon, expIDescription .expIIName, expIIPos, expIIMon,

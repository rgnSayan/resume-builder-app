        ...
        <div className="mainFile">
            ...
            {open ? (
                <div className="resume__container">
                    <Resume name={name} bio={bio} email={email} address={address} phone={phone} bday={bday} githubInput={githubInput} linkedinInput={linkedinInput} schoolNameX={schoolNameX} percentageX={percentageX} />
                </div>
            ) : null}

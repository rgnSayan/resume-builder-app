...
function Resume({ name, bio, email, address, phone, bday, githubInput, linkedinInput, schoolNameX,
    ...
    universityEndDate, sk1, sk2, sk3 = { sk3 } sk4 = { sk4 } sk5 = { sk5 } prDetails = { prDetails } prName = { prName } prLink = { prLink } prDetailsI = { prDet, ilsI } prNameI = { prNameI } prLinkI = { prLinkI } expIName = { expIIName } expIPos = { expIPos } expIMon = { expIIMon }

...
function Resume({ name, bio, email, address, phone, bday, githubInput, linkedinInput, schoolNameX,
    ...
    const saveFile = () => {
        saveAs(
            // "https://www.w3.org/WAI/ER/tests/xhtml/testfiles/resources/pdf/resume.pdf",
            // "resume.pdf"
        );
    };
    ...
    return (
        <Fragment>
            ...
            <div className="download">
                <Button variant="contained" color="secondary" disabled={!email} onClick={saveFile}>Download Resume
                </Button>
            </div>
        </Fragment>
    );

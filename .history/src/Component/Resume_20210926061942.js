                    ...
                    <div className="resume__projects">
                        <div className="projects__details">
                            ...
                            <div className="projects__content">
                                ...
                                <p>I build resume building app with React and Firebase. I have provided my details about my education, project and internships and also my certificates. </p>
                            </div>
                        </div>
                    </div>
                </div>

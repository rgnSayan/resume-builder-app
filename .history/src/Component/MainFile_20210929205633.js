...
function MainFile() {
    ...
    const submitHandler = (e) => {
        ...
        db.collection('resumeDetails').add({
            ...
            prDetails: prDetails, prName: prName, prLink: prLink
        } prDetailsI = { prDetailsI } prNameI = { prNameI } prLinkI = { prLinkI } expIName = { expIIName } expIPos = { expIPos } expIMon = { expIIMon }

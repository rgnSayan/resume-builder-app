                    ...
                    <div className="resume__projects">
                        <div className="projects__details">
                            ...
                            <div className="projects__content">
                                <h2>Portfolio</h2>
                                <a href="https://github.com/rgnSayan/my-portfolio-react" target="_blank" rel="noreferrer"><p>https://github.com/rgnSayan/my-portfolio-react</p></a>
                                <p>I build my own portfolio with React and Firebase .</p>
                            </div>
                        </div>
                    </div>
                </div>

...
function Resume({ name, bio, email, address, phone, bday, githubInput, linkedinInput, schoolNameX,
    percentageX, boardX, endDateX, startDateX, schoolNameXII = { schoolNameXII } percentageXII = { percentageXII } boardXII = { boardXII }
    ...
    universityEndDate = { universityEndDate } sk1 = { sk1 } sk2 = { sk2 } sk3 = { sk3 } sk4 = { sk4 } sk5 = { sk5 } prDetails = { prDetails } prName = { prName } prLink = { prLink } prDetailsI = { prDet, ilsI } prNameI = { prNameI } prLinkI = { prLinkI } expIName = { expIIName } expIPos = { expIPos } expIMon = { expIIMon }

...
import ArrowRightIcon from '@material-ui/icons/ArrowRight'; import TurnedInIcon from '@material-ui/icons/TurnedIn';
...
function MainFile() {
    ...
    const submitHandler = (e) => {
        ...
        db.collection('resumeDetails').add({
            ...
            prName: prName,
            prLink: prLink,
            prDetailsI: prDetailsI,
            prNameI: prNameI,
            prLinkI: prLinkI,
            expIName: expIIName,
            expIPos: expIPos,
            expIMon: expIIMon,
            expIDescription: expIDescription,
            expIIName: expIIName,
            expIIPos: expIIPos,
            expIIMon: expIIMon,
            expIIDescription: expIIDescription,
    ...
    return (
        <div className="mainFile">
            <div className="personalInfo">
                ...
                <div className="main__container">
                    <form className="infoContainer">
                        ...
                        <label htmlFor="text">Address (State)➤</label>
            ...
            <div className="btn" >
                <Button variant="contained" color="primary" endIcon={<TurnedInIcon />} onClick={submitHandler}
                    disabled={!name}>
                    Submit
                </Button>
                <Button variant="contained" color="secondary" onClick={() => setOpen(!open)}
                    endIcon={<InsertEmoticonIcon />} disabled={!name}>
                    Continue
                </Button>
            </div>

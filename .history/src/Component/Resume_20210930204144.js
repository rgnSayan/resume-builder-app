                ...
                <Fragment>
                        ...
                        <div className="resume__media">
                            <div className="media__containerLeft">
                                ...
                                <div className="resume__linkedin">
                                    <LinkedInIcon />
                                    <a href={items.data.linkedinInput} target="_blank" rel="noreferrer"><label>{items.data.linkedinInput}</label></a>
                                </div>
                            </div>
                    ...
                    <div className="download">
                        <Pdf targetRef={ref} filename="Resume.pdf">
                            {({ toPdf }) => <Button variant="contained" color="primary" onClick={toPdf}>
                                Download Resume
                            </Button>}
                        </Pdf>
                        <Button onClick={event => db.collection('resumeDetails').doc(items.id).delete()}
                            startIcon={<DeletetIcon />}
                        >
                            Remove
                        </Button>
                    </div>
